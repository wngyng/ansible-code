...
echo "php安装gcc等完成" >>/root/install.log
...
echo "php安装libiconv 完成" >>/root/install.log
...
echo "php安装epel-6 完成" >>/root/install.log
#安装软件
...
echo "php安装mcrypt等 完成" >>/root/install.log
#-----------------------------------------------------------
cd /files/php || exit
...
echo "php安装 php 完成" >>/root/install.log
...
echo "php安装复制配置文件 完成" >>/root/install.log
...
echo "php恢复 yum源 完成" >>/root/install.log
